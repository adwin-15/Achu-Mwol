...
Asena.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
    if (message.jid === '919562803423-1627735504@g.us') {
         ...
         if (regex1.test(message.message)) {              
            ...
            await message.client.sendMessage(message.jid,'my name is Achu-Mwol' , MessageType.text, {quoted: message.data })
         }
           ...
           await message.client.sendMessage(message.jid,'i know him he is my creator', MessageType.text, {quoted: message.data })
            ...
            await message.client.sendMessage(message.jid,'\n`Achu-Mwol ❣️` \n*github.com/adwin-15/Achu-Mwol*', MessageType.text, {quoted: message.data })
         }
          else if (regex7.test(message.message)) {
            await message.client.sendMessage(message.jid,'```I am Achu-Mwol.```', MessageType.text, {quoted: message.data })
         }
            ...
            await message.client.sendMessage(message.jid,'┌ *「 ABOUT 」* \n\n\n *HELLO I AM Achu-Mwol USED FOR ENTERTAINMENT PURPOSE AS YOU ARE MY USERS YOU SHOULD MAINTAIN YOUR DIGNITY*', MessageType.text, {quoted: message.data })
         }
